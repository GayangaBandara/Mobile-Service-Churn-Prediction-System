    ...
    <div className="privacy-container">
      <div className="privacy-header">
        ...
        <p className="privacy-subtitle">
          At TelcoChurn Insights, we take your privacy seriously. This policy
      ...
      <div className="privacy-content">
        <div className="privacy-section">
          ...
          <p className="privacy-text">
            At TelcoChurn Insights, we are committed to protecting your privacy
            and ensuring the security of your personal information. This Privacy
            Policy outlines how we collect, use, disclose, and safeguard your
            data when you interact with our website, mobile app, or services.
          </p>

          <p className="privacy-text">
            By using our services, you agree to the collection and use of
            information in accordance with this policy. We do not sell or rent
            your personal information. Your data is only shared as outlined in
            this Privacy Policy.
          </p>

          <p className="privacy-text">
            The TelcoChurn Insights application, including its design, features,
            and underlying technology, is protected by copyright and
            intellectual property laws. Any unauthorized copying, reproduction,
        ...
        <div className="privacy-section">
          ...
          <ul className="privacy-list">
            <li>
              ...
              services, we may ask for your name, email address, phone number,
              company name, and other contact details.
            </li>
            <li>
              <strong>Usage Data:</strong> We collect information on how you
              access and use our services, including your IP address, browser
              type, pages visited, time spent on pages, and other diagnostic
              data.
            </li>
            <li>
              <strong>Customer Data:</strong> Information about your customers
              that you upload or input into our system for analysis purposes.
            </li>
            <li>
        ...
        <div className="privacy-section">
          ...
          <ul className="privacy-list">
            <li>
              All sensitive information is encrypted using secure socket layer
              technology (SSL)
            </li>
        ...
        <div className="privacy-contact">
          ...
          <p className="privacy-contact-text">
            By email:{" "}
            <a
              href="mailto:privacy@telcochurn.com"
              className="privacy-contact-link"
            >
              privacy@telcochurn.com
            </a>
          </p>
          <p className="privacy-contact-text">
            By visiting our{" "}
            <Link href="/contact" className="privacy-contact-link">
              Contact Us
            </Link>{" "}
            page
          </p>
